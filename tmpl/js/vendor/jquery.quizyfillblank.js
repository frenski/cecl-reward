  ...
  $.fn.quizyFillBlank = function(options) {
    ...
    function handleDropOn( event, ui ) {
      ...
      if(anCount == phNum){
		...
		$('.quizy-fitb-answer').addClass('quizy-fitb-dropelement-disabled')
		$('.quizy-fitb-answer').removeClass('quizy-fitb-dropelement-reenable');
		$('.quizy-fitb-answer').unbind("click");
      }else {
		  ui.draggable.addClass('quizy-fitb-dropelement-reenable');
		  ui.draggable.bind( "click", function() {
			  ...
			  ui.draggable.removeClass('quizy-fitb-dropelement-reenable');
			  anCount--;
		  });
	  }
    }
	...
	// Adds position data for the revert
	// $(".ui-widget-content").data("left", $(".ui-widget-content").position().left)
	// 						.data("top", $(".ui-widget-content").position().top);
